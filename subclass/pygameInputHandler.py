...
class inputHandler():
    def __init__(self, boardStart):
        self.windowOffset = boardStart
            ...
            for event in pygame.event.get():
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if pygame.mouse.get_pressed()[0]:
                        ...
                        x = x / ((pygame.display.get_window_size()[0]+ self.windowOffset[0]) / 10)
                        y = y / ((pygame.display.get_window_size()[1] +  self.windowOffset[1])/ 10)
